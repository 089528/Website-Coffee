...
$kontens = query("SELECT * FROM konten WHERE kategori = 'Standar Mutu SNI'");
...
<html lang="en">
  <head>
    ...
    <title>Standar Nasional Mutu Biji Kopi</title>
  </head>
  ...
  <div class="jumbotron jumbotron-fluid index">
      <div class="container">
          <div class="row hero">
            <div class="col-md-7">
              <h1 class="textHero">Standar Nasional <br> Mutu Biji Kopi</h1>
              <div class="line"></div>
            </div>
            <div class="col-md-5">
              <img src="../img/coffee-beans.jpg" alt="" class="imgHero">
            </div>
          </div>
      </div>  
    </div>
